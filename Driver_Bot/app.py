        ...
        for event in output['entry']:
            ...
            for message in messaging:
                if message.get('message'):
                    ...
                    response_sent_text = input("""Welcome to fide driver page :) How can I help you?
                        \n 1. Greetings \n 2. Authentication \n 3. Payment \n 4. Rate us""")
                    if message['message'].get('text')=="1":
                        response_sent_text = get_message()
                        send_message(recipient_id, response_sent_text)
                    if message['message'].get('text')=="2":
                        response_sent_text = "Hello there! Here you can complete the authentication by uploading your identity card in electronic version."
                        send_message(recipient_id, response_sent_text)
